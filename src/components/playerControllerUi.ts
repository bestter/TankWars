...
export const AI_PROFILE_UI = {
  "v1-random": { optionKey: "controller_ai_simple", badge: "CPU" },
  "v2-heuristic": { optionKey: "controller_ai_ok", badge: "OK" },
  "v3-sniper": { optionKey: "controller_ai_sniper", badge: "SNIP" },
  "v4-smart": { optionKey: "controller_ai_expert", badge: "EXPT" },
} as const satisfies Record<AiProfile, { readonly optionKey: string; readonly badge: string }>;
